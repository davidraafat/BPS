<template>
  <div>
    <a href="https://api.whatsapp.com/send?phone=201205999434" target="_blank"
    ...
    <div class="page-header clear-filter" filter-color="black">
      ...
      <div class="container">
        <div class="content-center brand">
          <img class="n-logo" src="img/logo-white.png" alt=""  width="250px" style="max-width: 250px; margin-top: 6.5rem;"/>
          <h2 class="h1-seo" style="font-weight: 500;">We will </h2>
          <h3>Support YOU</h3>
        </div>
      </div>
    </div>
          ...
          <div class="section-story-overview">
            <div class="row">
              ...
              <div class="col-md-5">
                ...
                <p>
                  Our targets are to provide high quality products and service with the highest level of
                  business integrity and the least costs and To Whom It May Concern: be the top leading
                  company in Egypt market in this field.
                </p>
                <h3>
                  Our Mission
                </h3>
                <p>
                  <ul>
                    <li>Deliver excellent value, convince, and reliability to our customer.</li>
                    <li>Build long lasting strategic partnerships with our suppliers.</li>
                    <li>Provide great jobs for our employees.</li>
                    <li>Be a responsible corporate citizen in our society.</li>
                  </ul>
                </p>
                <h3>
                  What we do
...
export default {
  ...
  methods:{
    async SubmitForm(){
      await axios.post("https://formspree.io/f/mkgjwzav",this.form).then(res =>{
        Swal.fire({
          title: 'Email sent',
